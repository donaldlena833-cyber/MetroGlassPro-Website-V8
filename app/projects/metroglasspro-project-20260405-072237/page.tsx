...
export const metadata: Metadata = {
  ...
  description: 'A compact bathroom glass enclosure designed to reduce visual weight, improve light flow, and make the shower feel less closed in.',
  keywords: [
    'small bathroom shower glass NYC',
    'compact frameless enclosure',
    'clear shower glass',
  ],
  alternates: { canonical: 'https://metroglasspro.com/projects/metroglasspro-project-20260405-072237/' },
  robots: { index: false, follow: true },
  openGraph: {
    title: 'Small Bathroom Glass Enclosure With Better Light Flow',
    description: 'A compact bathroom glass enclosure designed to reduce visual weight, improve light flow, and make the shower feel less closed in.',
    url: 'https://metroglasspro.com/projects/metroglasspro-project-20260405-072237/',
    type: 'article',
    images: ['https://metroglasspro.com/gallery/mgp-20260405-072237-1-photo-2026-03-19-12-55-48-2.jpg'],
  },
}
...
const articleJsonLd = {
  ...
  '@type': 'Article',
  headline: 'Small Bathroom Glass Enclosure With Better Light Flow',
  description: 'A compact bathroom glass enclosure designed to reduce visual weight, improve light flow, and make the shower feel less closed in.',
  ...
  mainEntityOfPage: 'https://metroglasspro.com/projects/metroglasspro-project-20260405-072237/',
  image: 'https://metroglasspro.com/gallery/mgp-20260405-072237-1-photo-2026-03-19-12-55-48-2.jpg',
}
    ...
    <>
      ...
      <section className="bg-cream pt-20 sm:pt-32 pb-10 sm:pb-14">
        <div className="max-w-3xl mx-auto px-6 sm:px-10">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className="text-[11px] font-medium tracking-wider uppercase text-charcoal/40 bg-charcoal/[0.04] px-2.5 py-1 rounded-full">Small Bathroom Shower Glass</span>
          ...
          <h1 className="heading-serif text-charcoal text-3xl sm:text-5xl lg:text-6xl">
            Small Bathroom Glass Enclosure With Better Light Flow
          </h1>
          <p className="mt-4 text-charcoal/30 text-sm">2026-04-05</p>
        </div>
      </section>
      ...
      <section className="bg-cream pb-6 sm:pb-10">
        <div className="max-w-4xl mx-auto px-6 sm:px-10">
          <div className="rounded-lg overflow-hidden img-editorial">
            <img
              src="/gallery/mgp-20260405-072237-1-photo-2026-03-19-12-55-48-2.jpg"
              alt="Small NYC bathroom shower glass enclosure with clear frameless panels"
      ...
      <section className="bg-cream pb-20 sm:pb-28">
        <div className="max-w-3xl mx-auto px-6 sm:px-10 prose-mgp">
          <p>
            In a small bathroom, the wrong enclosure can make the room feel even tighter. This project used clear frameless glass to keep light moving through the space.
          </p>
          <p>
            The layout was kept simple so the glass solved the problem without becoming the main visual object.
          </p>

          <h2>What We Installed</h2>
          <p>
            Clear tempered glass and minimal chrome hardware give the shower a finished edge while keeping the room open. The enclosure is sized to the finished tile and surrounding clearances.
          </p>
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260405-072237-2-photo-2026-03-12-14-21-36.jpg"
                alt="Small NYC bathroom shower glass enclosure with clear frameless panels"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260405-072237-3-photo-2026-03-12-09-59-31.jpg"
                alt="Small NYC bathroom shower glass enclosure with clear frameless panels"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260405-072237-4-photo-2026-03-10-17-50-35.jpg"
                alt="Small NYC bathroom shower glass enclosure with clear frameless panels"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260405-072237-5-photo-2026-03-19-12-55-48.jpg"
                alt="Small NYC bathroom shower glass enclosure with clear frameless panels"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <h2>Our Process</h2>
          <p>
            Small bathrooms require checking vanity clearance, toilet clearance, entry width, and where the eye lands when you enter the room. Those details guide the final glass layout.
          </p>
