    ...
    <>
      ...
      <section className="bg-cream pb-20 sm:pb-28">
        <div className="max-w-3xl mx-auto px-6 sm:px-10 prose-mgp">
          ...
          <ul>
            <li><strong>New construction condos</strong> where bathrooms are designed around the walk-in concept from day one</li>
            <li><strong>Gut renovations</strong> in brownstones and co-ops where the entire bathroom is being rebuilt</li>
      ...
      <section className="bg-charcoal py-20 sm:py-24 text-center">
        <div className="max-w-2xl mx-auto px-6 sm:px-10">
          <h2 className="heading-serif text-white text-3xl sm:text-4xl">Want the walk-in spa experience?</h2>
          <p className="mt-3 text-white/40 text-base">We&apos;ll assess your shower and design the right panel.</p>
