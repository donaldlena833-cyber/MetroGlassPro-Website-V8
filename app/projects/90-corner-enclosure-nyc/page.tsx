      ...
      <section className="bg-cream pb-6 sm:pb-10">
        <div className="max-w-4xl mx-auto px-6 sm:px-10">
          <div className="rounded-lg overflow-hidden img-editorial aspect-[16/9]">
            <ResponsiveImage src="/editorial/configurations/90-corner-enclosure.jpg" alt="90-degree corner frameless glass shower enclosure with satin brass glass-to-glass hinge connecting two panels at right angle" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
