...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://metroglasspro.com/projects/metroglasspro-project-20260402-072239/' },
  openGraph: {
    title: 'Custom Glass Installation — MetroGlass Pro NYC',
    description: 'A recent custom frameless shower enclosure installation by MetroGlass Pro in NYC. Precision field measurements, chrome hardware, and a 5 to 7 business day turnaround from approval to install.',
    url: 'https://metroglasspro.com/projects/metroglasspro-project-20260402-072239/',
    type: 'article',
    images: ['https://metroglasspro.com/gallery/mgp-20260402-072239-1-photo-2026-03-10-17-24-40.jpg'],
  },
}
...
const articleJsonLd = {
  ...
  mainEntityOfPage: 'https://metroglasspro.com/projects/metroglasspro-project-20260402-072239/',
  image: 'https://metroglasspro.com/gallery/mgp-20260402-072239-1-photo-2026-03-10-17-24-40.jpg',
}
      ...
      <section className="bg-cream pb-6 sm:pb-10">
        <div className="max-w-4xl mx-auto px-6 sm:px-10">
          <div className="rounded-lg overflow-hidden img-editorial">
            <img
              src="/gallery/mgp-20260402-072239-1-photo-2026-03-10-17-24-40.jpg"
      ...
      <section className="bg-cream pb-20 sm:pb-28">
        <div className="max-w-3xl mx-auto px-6 sm:px-10 prose-mgp">
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260402-072239-2-photo-2026-03-16-21-39-55.jpg"
                alt="MetroGlass Pro custom glass installation NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260402-072239-3-photo-2026-03-13-09-52-44.jpg"
                alt="MetroGlass Pro custom glass installation NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260402-072239-4-photo-2026-03-10-17-47-20.jpg"
                alt="MetroGlass Pro custom glass installation NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260402-072239-5-photo-2026-03-16-20-21-33.jpg"
                alt="MetroGlass Pro custom glass installation NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
