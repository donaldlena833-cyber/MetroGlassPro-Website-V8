...
export const metadata: Metadata = {
  ...
  description: 'A frameless shower glass project where final post-tile measurements protected the fit, reveal lines, and hardware placement.',
  keywords: [
    'post tile shower glass measurement',
    'frameless shower glass NYC',
    'custom shower door fit',
  ],
  alternates: { canonical: 'https://metroglasspro.com/projects/metroglasspro-project-20260403-072242/' },
  robots: { index: false, follow: true },
  openGraph: {
    title: 'Shower Glass Installed After Final Tile Measurements',
    description: 'A frameless shower glass project where final post-tile measurements protected the fit, reveal lines, and hardware placement.',
    url: 'https://metroglasspro.com/projects/metroglasspro-project-20260403-072242/',
    type: 'article',
    images: ['https://metroglasspro.com/gallery/mgp-20260403-072242-1-photo-2026-03-16-13-26-17.jpg'],
  },
}
...
const articleJsonLd = {
  ...
  '@type': 'Article',
  headline: 'Shower Glass Installed After Final Tile Measurements',
  description: 'A frameless shower glass project where final post-tile measurements protected the fit, reveal lines, and hardware placement.',
  ...
  mainEntityOfPage: 'https://metroglasspro.com/projects/metroglasspro-project-20260403-072242/',
  image: 'https://metroglasspro.com/gallery/mgp-20260403-072242-1-photo-2026-03-16-13-26-17.jpg',
}
    ...
    <>
      ...
      <section className="bg-cream pt-20 sm:pt-32 pb-10 sm:pb-14">
        <div className="max-w-3xl mx-auto px-6 sm:px-10">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <span className="text-[11px] font-medium tracking-wider uppercase text-charcoal/40 bg-charcoal/[0.04] px-2.5 py-1 rounded-full">Post-Tile Measurement</span>
          ...
          <h1 className="heading-serif text-charcoal text-3xl sm:text-5xl lg:text-6xl">
            Shower Glass Installed After Final Tile Measurements
          </h1>
          <p className="mt-4 text-charcoal/30 text-sm">2026-04-03</p>
        </div>
      </section>
      ...
      <section className="bg-cream pb-6 sm:pb-10">
        <div className="max-w-4xl mx-auto px-6 sm:px-10">
          <div className="rounded-lg overflow-hidden img-editorial">
            <img
              src="/gallery/mgp-20260403-072242-1-photo-2026-03-16-13-26-17.jpg"
              alt="Frameless shower glass installed after final tile measurements in NYC"
      ...
      <section className="bg-cream pb-20 sm:pb-28">
        <div className="max-w-3xl mx-auto px-6 sm:px-10 prose-mgp">
          <p>
            The best time to measure shower glass is after the tile is finished. This project followed that rule, which let us capture the true opening instead of relying on rough dimensions.
          </p>
          <p>
            That extra discipline matters when the finished look depends on narrow reveals and clean hardware placement.
          </p>

          <h2>What We Installed</h2>
          <p>
            The enclosure uses clear tempered glass and chrome hardware, fabricated from the final field dimensions. The finished result keeps the tile visible and the shower entry clean.
          </p>
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260403-072242-2-photo-2026-03-16-21-41-02.jpg"
                alt="Frameless shower glass installed after final tile measurements in NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260403-072242-3-photo-2026-03-16-21-40-24.jpg"
                alt="Frameless shower glass installed after final tile measurements in NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260403-072242-4-photo-2026-03-12-09-58-40.jpg"
                alt="Frameless shower glass installed after final tile measurements in NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="mt-4 img-editorial">
              <img
                src="/gallery/mgp-20260403-072242-5-photo-2026-03-16-21-38-06.jpg"
                alt="Frameless shower glass installed after final tile measurements in NYC"
                className="w-full h-auto block"
                loading="lazy"
              />
          ...
          <h2>Our Process</h2>
          <p>
            We measure height, width, wall angle, curb pitch, and hardware positions on site. Those measurements become the fabrication basis for the final glass.
          </p>
