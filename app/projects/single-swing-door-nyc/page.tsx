    ...
    <>
      ...
      <section className="bg-cream pb-20 sm:pb-28">
        <div className="max-w-3xl mx-auto px-6 sm:px-10 prose-mgp">
          ...
          <h2>Glass thickness: 3/8&quot; vs 1/2&quot; for single doors</h2>
          <p>
          ...
          <h2>Inward vs outward swing: which direction?</h2>
          <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link href="/projects/sliding-bypass-doors-nyc/" className="text-orange text-[14px] hover:opacity-70 transition-opacity block">Sliding Bypass →</Link>
