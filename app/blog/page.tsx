...
const posts = [
  ...
  },
  {
    ...
    excerpt: 'How to plan Bronx frameless shower doors around finished tile, older walls, door swing, hardware, building access, and estimate photos.',
    image: '/editorial/nyc-local/frameless-shower-doors-bronx-hero.jpg',
    imageAlt: 'Frameless shower door and bathroom glass planning for a Bronx shower',
    date: 'June 2026',
  },
  {
    href: '/blog/frameless-shower-doors-queens-nyc-planning-guide/',
    label: 'Queens Guide',
    title: 'Frameless Shower Doors in Queens: NYC Planning Guide',
    excerpt: 'How to plan Queens frameless shower doors around finished tile, door swing, hardware, building access, and estimate photos.',
    image: '/editorial/nyc-local/frameless-shower-doors-queens-hero.jpg',
    imageAlt: 'Frameless shower door and bathroom glass planning for a Queens shower',
    date: 'June 2026',
  },
  {
    href: '/blog/frameless-shower-doors-brooklyn-nyc-planning-guide/',
    label: 'Brooklyn Guide',
    title: 'Frameless Shower Doors in Brooklyn: NYC Planning Guide',
    excerpt: 'How to plan Brooklyn frameless shower doors around apartment access, finished tile, door swing, hardware, and estimate photos.',
    image: '/editorial/nyc-local/frameless-shower-doors-brooklyn-hero.jpg',
    imageAlt: 'Frameless shower door and bathroom glass planning for a Brooklyn shower',
    date: 'June 2026',
  },
  {
    href: '/blog/frameless-shower-doors-manhattan-nyc-planning-guide/',
    label: 'Manhattan Guide',
    title: 'Frameless Shower Doors in Manhattan: NYC Planning Guide',
    excerpt: 'How to plan Manhattan frameless shower doors around finished tile, door swing, hardware, building access, and estimate photos.',
    image: '/editorial/nyc-local/frameless-shower-doors-manhattan-hero.jpg',
    imageAlt: 'Frameless shower door glass and hardware planning for a Manhattan bathroom',
    date: 'June 2026',
  },
  {
