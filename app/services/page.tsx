...
const services: ServiceItem[] = [
  ...
  { title: 'Glass Partitions', img: '/editorial/partition.jpg', desc: 'Interior dividers and boutique commercial partitions for projects that need crisp lines and reliable coordination.', points: ['Residential and boutique commercial', 'Layout review and site coordination', 'Clean sightlines and dependable hardware', 'Select railing work handled through project review'], link: '/glass-partitions-nyc/' },
