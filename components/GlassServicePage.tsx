...
export default function GlassServicePage({ id }: { id: string }) {
  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-10">
          ...
          <div className="grid lg:grid-cols-[1.6fr_1fr] gap-10 lg:gap-16 items-start">
            <div>
              ...
              <div className="flex flex-wrap gap-3 mt-8"><Link href={quote} className="btn-pill btn-primary px-7 py-3.5 text-sm">Request {service.name.toLowerCase()} estimate</Link><a href="tel:+13329993846" className="btn-pill btn-outline px-7 py-3.5 text-sm">Call (332) 999-3846</a></div>
            </div>
      ...
      <section className="bg-cream-light py-16 sm:py-24 border-y border-charcoal/10">
        <div className="max-w-6xl mx-auto px-6 sm:px-10">
